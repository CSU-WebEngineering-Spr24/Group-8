...
const DragonList = () => {
    ...
    useEffect(() => {
        fetch('https://8080-csuwebengineerin-group8-5268tr9qyah.ws-us110.gitpod.io/getdragons')
    ...
    return (
        <div className="container" style={{ backgroundColor: 'black', color: 'white', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
